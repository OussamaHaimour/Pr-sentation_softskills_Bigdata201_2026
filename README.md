...
* **📁 Quizzes_React/** : Applications interactives et code source des quiz créés par les étudiants.

## 📚 Thématiques (Dossier PPT)
1. **G1** : Relations professionnelles et communication.
2. **G2** : Adaptabilité et esprit d'équipe.
3. **G3** : Gestion des conflits (résolution et styles).
4. **G4** : Gestion du stress (sources et techniques).
5. **G5** : Marché de l'emploi et plan de carrière.
